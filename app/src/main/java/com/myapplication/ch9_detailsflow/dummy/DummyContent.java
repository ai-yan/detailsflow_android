package com.myapplication.ch9_detailsflow.dummy;
...
public class DummyContent {
    ...
    static {
        // Add 3 sample items.
        addItem(new DummyItem("1", "Ebay",
                "http://www.ebay.com"));
        addItem(new DummyItem("2", "Amazon",
                "http://www.amazon.com"));
        addItem(new DummyItem("3", "Gmail",
                "http://gmail.com"));
        addItem(new DummyItem("3", "Yahoo",
                "http://yahoo.com"));
        addItem(new DummyItem("3", "Microsoft",
                "http://microsoft.com"));
        addItem(new DummyItem("3", "Dell",
                "http://dell.com"));
    }
